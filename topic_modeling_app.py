...
#FIT_MODEL_____________________________________________________________________________________
    if algorithm == 'BERTopic':
        topic_doc_matrix, keyword_df, topic_term_matrix, doc_plot = BERT_topic(df, model, 'text', dir_out, lang, upper_ngram_range, min_topic_size, n_topics, input_format, timestamps)
        ...
        topic_doc_matrix, keyword_df, topic_term_matrix,doc_plot = top_2_vec(df, 'text', model, dir_out, n_topics, input_format, timestamps)
